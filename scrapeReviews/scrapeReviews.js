...
const review = require('../src/api/review/controllers/review');
...
async function scrapeAndSaveReviews() {
  try {
    ...
    await page.waitForSelector('.XltNde');

    await page.evaluate(async () => {
      const reviewElement = document.querySelector('.e07Vkf.kA9KIf');
      await reviewElement.scrollIntoView({ behavior: 'smooth', block: 'end' });
